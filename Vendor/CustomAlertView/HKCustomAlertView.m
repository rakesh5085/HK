...
@implementation HKCustomAlertView
...
- (id)initWithParentView: (UIView *)_parentView
{
    ...
    if (self) {
        ...
        // This is done to close the alertview
...
- (void)handleTap:(UITapGestureRecognizer *)recognizer
{
    ...
    if(self.delegate && [self.delegate respondsToSelector:@selector(customDialogButtonTouchUpInside:clickedButtonAtIndex:)])
    {
        [self.delegate customDialogButtonTouchUpInside:self clickedButtonAtIndex:[self tag]];
    }
}
