...
- (void) autoBadgeSizeWithString:(NSString *)badgeString
{
    ...
    NSDictionary *stringAttributes = [NSDictionary dictionaryWithObject:[UIFont systemFontOfSize:10] forKey: NSFontAttributeName];
    
	CGSize stringSize = [badgeString sizeWithAttributes:stringAttributes];
	CGFloat flexSpace;
...
- (void)drawRect:(CGRect)rect {
	...
	if ([self.badgeText length]>0)
    {
        ...
        NSDictionary *stringAttributes = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:sizeOfFont],NSFontAttributeName, nil  ];
        CGSize textSize_ = [self.badgeText sizeWithAttributes:stringAttributes];

        [self.badgeText drawAtPoint:CGPointMake((rect.size.width/2-textSize_.width/2), (rect.size.height/2-textSize_.height/2)) withAttributes:stringAttributes];
	}
